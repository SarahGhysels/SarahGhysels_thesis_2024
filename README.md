...
redistribute the threshold classes of the train set into the breeder's classes, because for the classification models it was thought to be more useful to work with these classes to create the stratified train-validation splits. 
The RF Models folder contains the three RF models: threshold, classification and regression.
